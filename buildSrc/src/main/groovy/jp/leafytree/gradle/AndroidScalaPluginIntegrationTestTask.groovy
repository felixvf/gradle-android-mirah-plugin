...
public class AndroidMirahPluginIntegrationTestTask extends DefaultTask {
    ...
    def run() {
        ...
        [
            ...
            [
                    ["2.2.1", true,  "0.1.5-SNAPSHOT", "1.1.3", "android-22", "22.0.1", "8", "22"],
                    ["2.2.1", false, "2.10.5", "1.1.3", "android-22", "22.0.1", "8", "22"],
                    ["2.2.1", false, "0.1.5-SNAPSHOT", "1.1.3", "android-22", "22.0.1", "21", "22"],
                    ["2.2.1", false, "2.10.5", "1.1.3", "android-22", "22.0.1", "21", "22"],
            ].each { testParameters ->
